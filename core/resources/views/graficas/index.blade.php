...
@section('titulo_grande','Gr&aacuteficas') @show
...
<canvas class='reportegrafica' id="myChart" width="300" height="100"></canvas>
...
<div class="box box-primary">
    ...
    <div class="box-body" id="div_grafica_barras_suma_pago_reservas">
    </div>
...
{!!Html::script('theme/dist/js/graficas/Chart.js')!!}

{!!Html::script('theme/dist/js/graficas/graficas.js')!!}
...
<script>
    ...
    cargar_grafica_barras_suma_pago_reservas(<?= $anio; ?>,<?= intval($mes); ?>);
    
    // cargar_grafica_barras_meses()
