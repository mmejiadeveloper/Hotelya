  ...
  <table width="100%">
    ...
    <tbody>
      <tr>
        ...
        <td align="right">{{$sub_datos[0]->total}}</td>
        <td align="right">{{$sub_datos[0]->total}}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td align="right">{{$sub_datos[0]->total-($sub_datos[0]->total*0.19)}}</td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td align="right">IVA  19% $</td>
        <td align="right">{{$sub_datos[0]->total* 0.19}}</td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td align="right">Total $</td>
            <td align="right" class="gray">{{ Auth::user() !=null ? $sub_datos[0]->total : 'Reserva no confirmada' }}</td>
        </tr>
    </tfoot>
  </table>
